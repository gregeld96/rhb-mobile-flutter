...
import 'package:rhb_mobile_flutter/controllers/parish/baptism.dart';
...
class BaptismParishScreen extends StatelessWidget {
  final BaptismParishController controller = Get.put(BaptismParishController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<BaptismParishController>(builder: (_) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              RehobotGeneralText(
                title: 'Tidak ada jadwal pelayanan baptis',
